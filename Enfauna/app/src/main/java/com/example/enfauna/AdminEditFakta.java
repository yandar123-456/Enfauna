...
public class AdminEditFakta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_edit_fakta);
        ...
        TombolEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                updateData();
                Toast.makeText(getApplicationContext(),"Data Fakta UNIK berhasil di Ubah", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        ...
        TombolHapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                deleteData();
                deleteFoto();
                Toast.makeText(getApplicationContext(),"Data Fakta UNIK berhasil di hapus", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
        ...
        editQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot addSnapshot : dataSnapshot.getChildren()){
                    ...
                    addSnapshot.getRef().child("fakta").setValue(Textfakta.getText().toString());
