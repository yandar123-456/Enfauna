...
public class AdminTambahHewan extends AppCompatActivity {
    ...
    EditText TextNama, TextAsal, TextPenjelasan, TextStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_tambah_hewan);
    ...
    private void uploadFoto() {
        ...
        if(filePath != null) {
            ...
            final StorageReference ref = STKoneksi.child("hewan/"+imagename);
    ...
    private void simpanData() {
        ...
        String imagename = TextNama.getText().toString();
        Model1 contact = new Model1(imagename,
                TextNama.getText().toString(),
                TextAsal.getText().toString(),
